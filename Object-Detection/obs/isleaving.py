...
import numpy as np
import os
known_people = ["Jack", "John", "Jill", "Ajay"]
...
def identify_faces(known_face_embeddings, image):
    ...
    if face_detection_status:
        ...
        if min_distance < 0.6:
            ...
            return True, known_people[min_distance_index] , start_x, start_y
        else:
            # Unknown face
...
def main():
    ...
    while True:
        ...
        face_recognition_status, person_name, start_x, start_y = identify_faces(known_face_embeddings, frame)
        ...
        if is_leaving(prev_x, prev_y, start_x, start_y, leaving_threshold):
            if face_recognition_status:
                ...
                print("Person is leaving:", person_name)
            else:
